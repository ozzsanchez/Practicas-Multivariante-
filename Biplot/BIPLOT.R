...
load("~/Esatadistica multivariada/BIPLOT/Vinos.rda")
...
# 5: Estandarizado por columnas  para este caso el 5 es el mejor 


acpvino<-PCA.Analysis(X,Scaling = 5)
summary(acpvino)

# Presentacion de tablas (markdown) para repote 
...
#  1:JK
#  2:HJ
# <-PCA.Biplot(X,alpha=2,Scaling = 5)
# Predeterminado JK
...
# metodo ward.D consiste en la suma de cuadrados del error 
