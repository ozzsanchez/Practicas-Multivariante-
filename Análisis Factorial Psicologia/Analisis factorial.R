...
# gráfico scater para la visualizacion de la matriz original 
# con las tres variables que se incluyeron 
pairs(x,col="blue", pch=19, main="Matriz original")
...
# eigen.vec[,1:3] los tres factores selecionados de varabilidad acumulada 
...
# calculo de la matriz de auto valores y autovectores 
eRP<-eigen(RP)                
eRP
